...
namespace DTO_QL
{
    public class DTO_IT
    {
        ...
        public DTO_IT(string idAcc, string username, string password, string idRole, bool trangThai, string roleId)
        {
            _IdAcc = idAcc;
            _Username = username;
            _Password = password;
        ...
        public DTO_IT(string idAcc, string password, string idRole)
        {
            _IdAcc = idAcc;
            _Password = password;
            _IdRole = idRole;
