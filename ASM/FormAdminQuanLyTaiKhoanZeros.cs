...
namespace ASM
{
    public partial class FormAdminQuanLyTaiKhoanZeros : Form
    {
        BUS_IT QlTaiKhoan = new BUS_IT();
        private bool isAdding = false;
        public FormAdminQuanLyTaiKhoanZeros()
        {
            InitializeComponent();
            LoadDsTk();
            LoadDanhSachrole();
        ...
        {
            //if (dgvDatatK.CurrentRow != null)
            //{
            //    string trangThai = dgvDatatK.CurrentRow.Cells["TrangThai"]?.Value?.ToString() ?? string.Empty;
        ...
        {
            dgvDatatK.DataSource = QlTaiKhoan.LoadDsTkGLOBALBAN();
