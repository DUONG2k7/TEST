...
namespace ASM
{
    public partial class FormAdminQuanLyTaiKhoanADMIN : Form
    {
        BUS_IT QlTaiKhoan = new BUS_IT();
        private bool isAdding = false;
        public FormAdminQuanLyTaiKhoanADMIN()
        {
            InitializeComponent();
            LoadDsTk();
            LoadDanhSachrole();
        ...
        {
            dgvDatatK.DataSource = QlTaiKhoan.LoadDsTkIT();
        ...
        private void btnLoU_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Không thể khóa tài khoản admin cuối cùng", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                DTO_IT taikhoan = new DTO_IT(txtMaTk.Text, txtMk.Text, cbRole.SelectedValue.ToString());
